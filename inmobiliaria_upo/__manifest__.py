# -*- coding: utf-8 -*-
{
    ...
    'assets':{
    	'web.assets_backend': [
            'inmobiliaria_upo/static/src/components/owlAlquiler/owlAlquiler.js',
            'inmobiliaria_upo/static/src/components/owlAlquiler/owlAlquiler.xml',
            'inmobiliaria_upo/static/src/components/owlAlquiler/owlAlquiler.scss',
    	],
    },
    'application': True,
}
